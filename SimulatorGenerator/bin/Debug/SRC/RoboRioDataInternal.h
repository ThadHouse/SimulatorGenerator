...
class RoboRioData {
 public:
  ...
  void InvokeFPGAButtonCallback(const HAL_Value* value);
  ...
  void InvokeVInVoltageCallback(const HAL_Value* value);
  ...
  void InvokeVInCurrentCallback(const HAL_Value* value);
  ...
  void InvokeUserVoltage6VCallback(const HAL_Value* value);
  ...
  void InvokeUserCurrent6VCallback(const HAL_Value* value);
  ...
  void InvokeUserActive6VCallback(const HAL_Value* value);
  ...
  void InvokeUserVoltage5VCallback(const HAL_Value* value);
  ...
  void InvokeUserCurrent5VCallback(const HAL_Value* value);
  ...
  void InvokeUserActive5VCallback(const HAL_Value* value);
  ...
  void InvokeUserVoltage3V3Callback(const HAL_Value* value);
  ...
  void InvokeUserCurrent3V3Callback(const HAL_Value* value);
  ...
  void InvokeUserActive3V3Callback(const HAL_Value* value);
  ...
  void InvokeUserFaults6VCallback(const HAL_Value* value);
  ...
  void InvokeUserFaults5VCallback(const HAL_Value* value);
  ...
  void InvokeUserFaults3V3Callback(const HAL_Value* value);
