...
class DIOData {
 public:
  ...
  void InvokeValueCallback(const HAL_Value* value);
  HAL_Bool GetValue();
  ...
  void InvokePulseLengthCallback(const HAL_Value* value);
  ...
  void InvokeIsInputCallback(const HAL_Value* value);
  HAL_Bool GetIsInput();
  ...
  void InvokeFilterIndexCallback(const HAL_Value* value);
